...
import { BasicDictionaryBuilder,
         DictionaryViewConfig,
         DictionarySource } from '@alexamies/chinesedict-js';

console.log('Loading demo_extend_app');

// Build and initialize the dictionary
const source = new DictionarySource('/assets/ntireader.json',
    'NTI Reader Dictionary',
	'Creative Commons Attribution-Share Alike 3.0 License (CCASE 3.0).');
